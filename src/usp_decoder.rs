...
/// Decodes a protobuf bytestream of a USP Record into a Record structure for further processing
///
/// # Arguments
///
/// * `bytes` - The protobuf bytestream to parse
///
/// # Example
///
/// ```
...
/// Decodes a protobuf bytestream of a USP Msg into a Msg structure for further processing
///
/// # Arguments
///
/// * `bytes` - The protobuf bytestream to parse
