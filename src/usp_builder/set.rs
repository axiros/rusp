...
impl<'a> UpdateObjectBuilder {
    ...
    pub fn build(self) -> Result<UpdateObject<'a>> {
...
impl<'a> SetBuilder {
    ...
    pub fn add_update_obj(mut self, update_obj: UpdateObjectBuilder) -> Self {
        self.update_objs.push(update_obj);
        self
    }
...
impl UpdatedInstanceFailureBuilder {
    ...
    pub fn add_param_err(mut self, param_errs: SetRespParameterError) -> Self {
        self.param_errs.push(param_errs);
        self
    }
}
...
pub enum SetOperationStatus {
    ...
    Success(SetOperationSuccessBuilder),
    None,
}
...
impl SetOperationStatus {
    ...
    pub fn set_success(
        ...
        Self::Success(SetOperationSuccessBuilder {
            affected_path,
            param_errs,
            updated_params,
        })
...
impl UpdatedObjectResultsBuilder {
    pub fn new(requested_path: String, oper_status: SetOperationStatus) -> Self {
        Self {
            requested_path,
            oper_status,
        }
    ...
    pub fn build<'a>(self) -> Result<UpdatedObjectResult<'a>> {
...
impl SetRespBuilder {
    ...
    pub fn add_updated_obj_results(
        mut self,
        updated_obj_results: UpdatedObjectResultsBuilder,
    ) -> Self {
        self.updated_obj_results.push(updated_obj_results);
        self
    }
