...
impl<'a> GetSupportedDMBuilder {
    ...
    pub fn add_obj_paths(mut self, obj_path: String) -> Self {
...
impl<'a> GSDMCommandResult {
    ...
    pub fn add_input_arg_name(mut self, input_arg_name: String) -> Self {
        self.input_arg_names.push(input_arg_name);
        self
    }
    ...
    pub fn add_output_arg_name(mut self, output_arg_name: String) -> Self {
        self.output_arg_names.push(output_arg_name);
        self
    }
    ...
    pub fn build(self) -> Result<SupportedCommandResult<'a>> {
...
impl<'a> GSDMEventResult {
    ...
    pub fn add_arg_name(mut self, arg_name: String) -> Self {
        self.arg_names.push(arg_name);
        self
    }

    pub fn build(self) -> Result<SupportedEventResult<'a>> {
...
impl<'a> GSDMParamResult {
    ...
    pub fn build(self) -> Result<SupportedParamResult<'a>> {
...
impl<'a> GSDMSupportedObjectResult {
    pub fn new(supported_obj_path: String) -> Self {
        Self {
            supported_obj_path,
            access: OBJ_ADD_ONLY,
    ...
    pub fn add_supported_command(mut self, supported_command: GSDMCommandResult) -> Self {
        self.supported_commands.push(supported_command);
        self
    }
    ...
    pub fn add_supported_event(mut self, supported_event: GSDMEventResult) -> Self {
        self.supported_events.push(supported_event);
        self
    }
    ...
    pub fn add_supported_param(mut self, supported_param: GSDMParamResult) -> Self {
        self.supported_params.push(supported_param);
        self
    }

    pub fn build(self) -> Result<SupportedObjectResult<'a>> {
...
impl<'a> GSDMReqObjectResultBuilder {
    pub fn new(req_obj_path: String) -> Self {
        Self {
            req_obj_path,
            err_code: 0,
            err_msg: None,
            data_model_inst_uri: "".into(),
            supported_objs: vec![],
        }
    }
    ...
    pub fn add_supported_obj(mut self, supported_obj: GSDMSupportedObjectResult) -> Self {
        self.supported_objs.push(supported_obj);
        self
    }

    pub fn build(self) -> Result<RequestedObjectResult<'a>> {
        let err_msg = self
            .err_msg
            .clone()
...
impl<'a> GetSupportedDMRespBuilder {
    pub fn new() -> Self {
        Self {
            req_obj_results: vec![],
        }
    ...
    pub fn add_req_obj_result(mut self, req_obj_result: GSDMReqObjectResultBuilder) -> Self {
        self.req_obj_results.push(req_obj_result);
        self
    }
