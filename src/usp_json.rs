...
impl Serialize for mod_Header::MsgType {
    ...
    where
        S: Serializer,
    {
        use mod_Header::MsgType::{ADD, ADD_RESP, DELETE, DELETE_RESP, DEREGISTER, DEREGISTER_RESP, ERROR, GET, GET_INSTANCES, GET_INSTANCES_RESP, GET_RESP, GET_SUPPORTED_DM, GET_SUPPORTED_DM_RESP, GET_SUPPORTED_PROTO, GET_SUPPORTED_PROTO_RESP, NOTIFY, NOTIFY_RESP, OPERATE, OPERATE_RESP, REGISTER, REGISTER_RESP, SET, SET_RESP};
...
impl Serialize for Body<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_Body::OneOfmsg_body::{None, error, request, response};
...
impl Serialize for Request<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_Request::OneOfreq_type::{None, add, delete, deregister, get, get_instances, get_supported_dm, get_supported_protocol, notify, operate, register, set};
...
impl Serialize for Response<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_Response::OneOfresp_type::{None, add_resp, delete_resp, deregister_resp, get_instances_resp, get_resp, get_supported_dm_resp, get_supported_protocol_resp, notify_resp, operate_resp, register_resp, set_resp};
...
impl Serialize for Notify<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_Notify::OneOfnotification::{None, event, obj_creation, obj_deletion, on_board_req, oper_complete, value_change};
...
impl Serialize for mod_Notify::OperationComplete<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_Notify::mod_OperationComplete::OneOfoperation_resp::{None, cmd_failure, req_output_args};
...
impl Serialize for mod_GetSupportedDMResp::ObjAccessType {
    ...
    where
        S: Serializer,
    {
        use mod_GetSupportedDMResp::ObjAccessType::{OBJ_ADD_DELETE, OBJ_ADD_ONLY, OBJ_DELETE_ONLY, OBJ_READ_ONLY};
...
impl Serialize for mod_GetSupportedDMResp::ParamValueType {
    ...
    where
        S: Serializer,
    {
        use mod_GetSupportedDMResp::ParamValueType::{PARAM_BASE_64, PARAM_BOOLEAN, PARAM_DATE_TIME, PARAM_DECIMAL, PARAM_HEX_BINARY, PARAM_INT, PARAM_LONG, PARAM_STRING, PARAM_UNKNOWN, PARAM_UNSIGNED_INT, PARAM_UNSIGNED_LONG};
...
impl Serialize for mod_GetSupportedDMResp::ValueChangeType {
    ...
    where
        S: Serializer,
    {
        use mod_GetSupportedDMResp::ValueChangeType::{VALUE_CHANGE_ALLOWED, VALUE_CHANGE_UNKNOWN, VALUE_CHANGE_WILL_IGNORE};
...
impl Serialize for mod_GetSupportedDMResp::ParamAccessType {
    ...
    where
        S: Serializer,
    {
        use mod_GetSupportedDMResp::ParamAccessType::{PARAM_READ_ONLY, PARAM_READ_WRITE, PARAM_WRITE_ONLY};
...
impl Serialize for mod_SetResp::mod_UpdatedObjectResult::OperationStatus<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_SetResp::mod_UpdatedObjectResult::mod_OperationStatus::OneOfoper_status::{None, oper_failure, oper_success};
...
impl Serialize for mod_OperateResp::OperationResult<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_OperateResp::mod_OperationResult::OneOfoperation_resp::{None, cmd_failure, req_obj_path, req_output_args};
...
impl Serialize for mod_RegisterResp::mod_RegisteredPathResult::OperationStatus<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_RegisterResp::mod_RegisteredPathResult::mod_OperationStatus::OneOfoper_status::{None, oper_failure, oper_success};
...
impl Serialize for mod_DeleteResp::mod_DeletedObjectResult::OperationStatus<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_DeleteResp::mod_DeletedObjectResult::mod_OperationStatus::OneOfoper_status::{None, oper_failure, oper_success};
...
impl Serialize for mod_AddResp::mod_CreatedObjectResult::OperationStatus<'_> {
    ...
    where
        S: Serializer,
    {
        use mod_AddResp::mod_CreatedObjectResult::mod_OperationStatus::OneOfoper_status::{None, oper_failure, oper_success};
        let mut state = serializer.serialize_struct("OperationStatus", 1)?;
        match self.oper_status {
            oper_success(ref m) => state.serialize_field("oper_success", m)?,
            oper_failure(ref m) => state.serialize_field("oper_failure", m)?,
