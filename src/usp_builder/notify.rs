...
impl<'a> NotifyBuilder {
    ...
    pub fn build(self) -> Result<Body<'a>> {
        ...
        let notify_type = match notify_type {
            ...
            } => on_board_req(mod_Notify::OnBoardRequest {
            ...
            NotifyType::ValueChange {
                param_path,
                param_value,
            } => value_change(mod_Notify::ValueChange {
            ...
            NotifyType::ObjectCreation {
                obj_path,
                unique_keys,
            } => obj_creation(mod_Notify::ObjectCreation {
                obj_path: obj_path.into(),
            ...
            NotifyType::ObjectDeletion { obj_path } => obj_deletion(mod_Notify::ObjectDeletion {
                obj_path: obj_path.into(),
            }),
            NotifyType::OperationComplete {
                ...
                command_key,
                operation_resp,
            } => oper_complete(mod_Notify::OperationComplete {
                obj_path: obj_path.into(),
